...
+ {not hasFlag("bridge_crossing_earned")} [Ask about the riddle] -> riddle_info
+ [Ask about the bridge] -> bridge_info
+ [Ask about his book] -> book_info
+ {hasFlag("bridge_crossing_earned")} [Just passing through] -> farewell_friendly
+ [Leave] -> farewell

=== riddle_info ===
Bertram straightens his vest professionally. #speaker:Bertram #emotion:serious
Bridge Troll Regulations, Chapter 7: All crossers must answer one riddle before crossing.
...
He waits patiently. 'Say the answer when you know it. Take your time -- I've got three hundred pages left of this mystery novel.' #speaker:Bertram #emotion:friendly
~ setFlag("riddle_heard")
-> END
...
He pauses.
Books are the best part of bridge trolling. Not much foot traffic these days.
-> greeting
